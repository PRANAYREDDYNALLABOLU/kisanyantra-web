...
export default function Page() {
  ...
  return (
    <div style={{ background: '#FAFAF8', color: '#1A1A1A', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          ...
          <div style={{
            ...
            {NAV.map(item => (
              <a key={item.label} href={item.href}
                ...
                style={{ display: 'block', padding: '14px 0', color: '#1A1A1A', fontWeight: 600, fontSize: 16, textDecoration: 'none', borderBottom: '1px solid #F0EDE6' }}
              >
                {item.label}
              </a>
            ))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 64, alignItems: 'center' }}>
            ...
            <div className="animate-fadeUp">
              ...
              <div style={{
                ...
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#D4A017', display: 'inline-block', animation: 'pulse-ring 2.5s infinite' }} />
              ...
              <div style={{
                ...
                {[
                  ...
                  <StatCounter key={i} value={s.v} label={s.l} />
                ))}
              </div>
            </div>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ maxWidth: 560, marginBottom: 64 }} ref={featuresRef}>
            ...
            <p style={{ color: '#8A8A8A', fontSize: 17, lineHeight: 1.7 }}>
              No middlemen. No phone calls. No waiting for someone to show up. Just open the app and watch it work.
            </p>
          </div>
      ...
      {/* ── Equipment ── */}
      <section id="equipment" style={{ padding: '100px 24px', background: '#F0EDE6' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
      ...
      {/* ── For drivers ── */}
      <section id="for-drivers" style={{ padding: '100px 24px', background: '#1B4332', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 64, alignItems: 'center' }}>
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 17, lineHeight: 1.8, marginBottom: 40 }}>
                Register your tractor or equipment. Receive ride requests from verified farmers. Navigate with our shortest route engine. Get paid.
              </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: '20px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ color: 'rgba(255,255,255,0.6)', fontWeight: 600 }}>Per ride</span>
                <span style={{ color: '#D4A017', fontWeight: 900, fontSize: 22, fontFamily: 'Fraunces, serif' }}>₹800–2,500</span>
              </div>
              <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: '20px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ color: 'rgba(255,255,255,0.6)', fontWeight: 600 }}>Daily avg.</span>
                <span style={{ color: '#D4A017', fontWeight: 900, fontSize: 22, fontFamily: 'Fraunces, serif' }}>₹2,000–5,000</span>
              </div>
              <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: '20px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ color: 'rgba(255,255,255,0.6)', fontWeight: 600 }}>Monthly potential</span>
                <span style={{ color: '#D4A017', fontWeight: 900, fontSize: 22, fontFamily: 'Fraunces, serif' }}>₹50,000+</span>
              </div>
              <div style={{ background: 'rgba(212,160,23,0.1)', border: '1px solid rgba(212,160,23,0.2)', borderRadius: 16, padding: '14px 20px', marginTop: 8 }}>
                <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12 }}>
                  * Based on 8 working hours per day. Actual earnings vary by location and demand.
                </div>
              </div>
            </div>
          </div>
              ...
              <div key={i} className="card-lift" style={{
                ...
                <div style={{ display: 'flex', gap: 3 }}>
                  {[...Array(t.stars)].map((_, j) => (
                    <span key={j} style={{ color: '#D4A017', fontSize: 16 }}>★</span>
                  ))}
                </div>
                {/* Quote */}
                <p style={{ color: '#4A4A4A', fontSize: 16, lineHeight: 1.75, flex: 1, fontStyle: 'italic' }}>
                  &ldquo;{t.quote}&rdquo;
                </p>
                {/* Author */}
      ...
      <section id="download" style={{
        padding: '100px 24px',
        background: 'linear-gradient(150deg, #0D2818 0%, #1B4332 60%, #2D6A4F 100%)',
        position: 'relative', overflow: 'hidden',
      }}>
        <div style={{ position: 'absolute', inset: 0, opacity: 0.04, backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)', backgroundSize: '28px 28px' }} />
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center', marginBottom: 40 }}>
            ...
            onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = '0 8px 32px rgba(212,160,23,0.5)'; }}
            onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 24px rgba(212,160,23,0.4)'; }}
            >
              <span style={{ fontSize: 28 }}>🌾</span>
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontSize: 11, opacity: 0.7, fontWeight: 600 }}>I am a farmer</div>
                <div style={{ fontSize: 17 }}>KisanYantra App</div>
              </div>
            </a>
            <a href="#" style={{
              display: 'flex', alignItems: 'center', gap: 14,
            ...
            >
              <span style={{ fontSize: 28 }}>🚜</span>
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontSize: 11, opacity: 0.7, fontWeight: 600 }}>I own equipment</div>
                <div style={{ fontSize: 17 }}>Driver App</div>
              </div>
            </a>
          </div>
      ...
      {/* ── Contact ── */}
      <section id="contact" style={{ padding: '100px 24px', background: '#F0EDE6' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
    ...
    {link.label}
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 32, display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 16 }}>
            <p style={{ color: 'rgba(255,255,255,0.25)', fontSize: 13 }}>
              © 2026 KisanYantra. All rights reserved.
            </p>
            <p style={{ color: 'rgba(255,255,255,0.2)', fontSize: 13 }}>
              Made with ❤️ for Indian Farmers • Hyderabad, India
            </p>
          </div>
        </div>
      </footer>
